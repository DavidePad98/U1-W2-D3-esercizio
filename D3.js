...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  charactersNames.push(charactersNames);
}
...
console.log("Female Character", femaleCharacters);
...
console.log("Colore e nome", eyeColor);
...
console.log("Totale della massa ", crewMass);
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") {
    ...
    console.log("gender", starWarsCharacters[i].gender);
  }
}
/* --EXTRA-- ESERCIZIO 9
...
let rElements = starWarsCharacters[random];
console.log("Elemento random", rElements);
